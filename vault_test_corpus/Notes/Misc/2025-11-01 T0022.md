...
created: " 2025-11-01"
pageType: misc
datelink: "[[November 01, 2025]]"
---
#  2025-11-01 T 0022

Oren's app loresmith is a RAG app which is designed to help Game Masters run long term dungeons and dragons campaigns. This app has two fundamental roles: 
1. Acting as the collection point for the world knowledge and session over session evolution in game state
2. Assisting the GM in planning, running, and debriefing sessions for the players. 

Campaigns are singular instances of a DnD game which has a unique world, players, and story. 

# GraphRAG Architecture Design for D&D DM Assistant
